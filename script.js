...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setTheme(theme) {
    ...
    body.classList.remove('blue','gray','slate', 'neutral','teal','cyan','green','orange','yellow');
  ...
  // Check the user's preference from a previous visit
...
function calculateTypingSpeed() {
    const typedText = textInput.innerText.trim();
    ...
    typingSpeedDisplay.textContent = wordsPerMinute;

    // Adjust the word count to exclude leading/trailing whitespaces
    if (typedText === '') {
        wordCount = 0;
        startTime = null;
    }
